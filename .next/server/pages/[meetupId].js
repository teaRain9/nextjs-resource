...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ DetailPage; });
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://adel:c3hqCAq3HVkF1JWX@cluster0.v3imuty.mongodb.net/?retryWrites=true&w=majority");
  const db = client.db();
